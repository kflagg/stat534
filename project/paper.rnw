...
plot(43560 * ex_p2$estimate, zlim = c(0, 300), main = '2nd Degree')
plot(43560 * ex_p3$estimate, zlim = c(0, 300), main = '3rd Degree')
...
plot(43560 * ex_kde, zlim = c(0, 500), main = 'Kernel Density')
@
...
resonable because locations in the interior of the region have the most nearby
...
<<polyse1, fig.width = 6, fig.height = 4, fig.pos = 't', fig.cap = 'Log standard errors for six of the polynomial models.'>>=
