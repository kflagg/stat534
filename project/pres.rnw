...
\item Dummy points outside the actual window are discarded
...
\item I place 128 evenly-spaced dummy points along each transect

\begin{itemize}

\item \Sexpr{prettyNum(ex_Q$dummy$n, big.mark = ',')} are used
